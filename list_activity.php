                            ...
                            <div class="said_ctg fix">
                                ...
                                <ul class="text-uppercase m-top-40">
                                    ...
                                    <li class="list groupList01" id="">
                                        ...
                                        <p class="list">圖片權利註記：[圖片權利註記]</p>
                                        <p class="list">開始日期：[開始日期]</p>
                                        <p class="list">結束日期：[結束日期]</p>
                                        <p class="list">發生地點：[發生地點]</p>
                                        <p class="list">活動/事件介紹描述資料：[描述資料]</p>
                                        <p class="list">關鍵字：[關鍵字]</p>
                                        <p class="list">活動分類一：[活動分類一]</p>
                                        <p class="list">活動分類二：[活動分類二]</p>
                                    </li>
                                    <li>
                                        <span class="list">[名稱]</span>
                                    ...
                                    <li class="list groupList02" id="">
                                        ...
                                        <p class="list">地點類別：[地點樂別]</p>
                                        <p class="list">撰寫者：[撰寫者]</p>
                                        <p class="list">作品/文物介紹描述資料：[描述資料]</p>
                                        <p class="list">關鍵字：[關鍵字]</p>
                                        <p class="list">作品分類一：[作品分類一]</p>
                                        <p class="list">作品分類二：[作品分類二]</p>
