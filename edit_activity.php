...
<body data-spy="scroll" data-target=".navbar-collapse">
                ...
                <div class="row">
                    <div class="main_testimonial">
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            <form action="api/submit.php" method="post" enctype="multipart/form-data" name="sentMessage" id="" novalidate>
                                <div class="col-sm-10 col-sm-offset-1">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>撰寫者:</label>
                                            <input type="text" class="form-control" id="Writer" required="" data-validation-required-message="Please enter your name.">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>圖片權利註記:</label>
                                            <select id="ImgAuthorization" name="" class="form-control-dropdown form-control">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>名稱:</label>
                                            <input type="text" class="form-control" id="ActivityName" required="" data-validation-required-message="Please enter your title.">
                                            <p class="help-block"></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>開始日期:</label>
                                            <input type="date" class="form-control" id="StartTime" required="" data-validation-required-message="請輸入發表時間">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>結束日期:</label>
                                            <input type="date" class="form-control" id="FinishTime" required="" data-validation-required-message="請輸入發表時間">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>活動/事件介紹描述資料:</label>
                                            <textarea class="form-control" id="ActivityDescription" maxlength="500" placeholder=""></textarea>
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>活動分類一:</label>
                                            <select id="ActivityClassOne" name="" class="form-control-dropdown form-control">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>活動分類二:</label>
                                            <select id="ActivityClassTwo" name="" class="form-control-dropdown form-control">
                                    ...
                                    <button type="submit" onclick="Activityinsert()" class="btn btn-default">發表新文章</button>
                                </div>
    ...
    <!-- include FilePond jQuery adapter -->
    <!-- script src="assets/js/filepond.jquery.js"></script -->
    <script src="assets/js/main.js"></script>
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC0YHjxhTqUPSIQtCRRLPsKmYZ8NUmiX00&callback=initMap">
    </script>


    <script src="assets/js/PHmain.js"></script>
    <script src="assets/js/api/activityInsert.js"></script>
</body>
