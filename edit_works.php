...
<body data-spy="scroll" data-target=".navbar-collapse">
                            ...
                            <form name="sentMessage" id="" novalidate>
                                <div class="col-sm-10 col-sm-offset-1">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>媒體類型:</label>
                                            <select name="" class="form-control-dropdown form-control" id = "MediaClass">
                                                <option value="video">圖書手冊</option>
                                                <option value="redio">照片</option>  
                                                <option value="newspaper">報紙</option>  
                                                <option value="write">手稿/手抄本</option>  
                                                <option value="img">圖稿</option>  
                                                <option value="doc">文件</option>  
                                                <option value="card">卡片</option>  
                                                <option value="poster">海報</option>  
                                                <option value="menu">節目單/節目冊/DM</option>  
                                                <option value="music">樂譜/曲譜</option>  
                                                <option value="script">劇本</option>  
                                                <option value="video">影音資料</option>  
                                                <option value="sound">錄音帶</option>  
                                                <option value="movie">錄影帶</option>  
                                                <option value="cd">光碟片</option>  
                                                <option value="mSheet">磁片</option>  
                                                <option value="microfilm">微縮捲片</option>  
                                                <option value="vRecords">黑膠唱片/蟲膠唱片</option>  
                                                <option value="usb">硬碟/隨身碟/記憶卡</option>  
                                                <option value="nfilm">底片</option>  
                                                <option value="tCultural">有形文物</option>  
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>圖片權利註記:</label>
                                            <select name="" class="form-control-dropdown form-control" id = "ImgAuthorization">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>時間資訊-類型:</label>
                                            <select name="" class="form-control-dropdown form-control" id = "DateClass">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            ...
                                            <input type="date" class="form-control" id="Date" required=""
                                                data-validation-required-message="請輸入發表時間">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>地點類別:</label>
                                            <select name="" class="form-control-dropdown form-control " id = "PlaceClass">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>作品/文物介紹描述資料:</label>
                                            <textarea maxlength="500" class="form-control" id="WorkDescription" placeholder=""></textarea>
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>作品分類一:</label>
                                            <select id = "WorkClassOne" name="" class="form-control-dropdown form-control">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>作品分類二:</label>
                                            <select id = "WorkClassTwo" name="" class="form-control-dropdown form-control">
                                    ...
                                    <button type="submit" class="btn btn-default" onclick="workinsert()">發表新文章</button>
                                </div>
    ...
    <script src="assets/js/api/workInsert.js"></script>
    <script>
