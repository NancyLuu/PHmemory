                            ...
                            <div class="said_ctg fix">
                                ...
                                <ul class="text-uppercase m-top-40">
                                    ...
                                    <li class="list groupList01" id="">
                                        ...
                                        <p class="list">姓名：[姓名]</p>
                                        <p class="list">性別：[性別]</p>
                                        <p class="list">國籍：[國籍]</p>
                                        <p class="list">生日：[生日]</p>
                                        <p class="list">出生地址：[出生地址]</p>
                                        <p class="list">人物介紹描述資料：[描述資料]</p>
                                        <p class="list">關鍵字：[關鍵字]</p>
                                        <p class="list">人物分類一：[人物分類一]</p>
                                        <p class="list">人物分類二：[人物分類二]</p>
                                    </li>
                                    <li>
                                        <span class="list">[名稱]</span>
