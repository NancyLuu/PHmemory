...
<body data-spy="scroll" data-target=".navbar-collapse">
                    ...
                    <div class="col-md-12">
                        <div class="blog_saidbar sm-m-top-70">
                            <div class="said_ctg fix">
                                <h6 class="text-uppercase">上傳檔案列表</h6>
                                <ul class="text-uppercase m-top-40">

                                    <li>
                                        <a href="./list_works.php">作品/文物</a><a id = "worknum"> (0)</a>
                                        <a class="btn btn-primary pull-right" id="" href="edit_works.php">新增</a>
                                    </li>
                                    <li>
                                        <a href="list_video.php">影音資料</a><a id = "videonum"> (0)</a>
                                        <a class="btn btn-primary pull-right" id="" href="edit_video.php">新增</a>
                                    </li>

                                    <li>
                                        <a href="list_organization.php">組織</a><a id = "orgnum"> (0)</a>
                                        <a class="btn btn-primary pull-right" id="" href="edit_organization.php">新增</a>
                                    <li>
                                        <a href="list_space.php">空間</a><a id = "spacenum"> (0)</a>
                                        <a class="btn btn-primary pull-right" id="" href="edit_space.php">新增</a>
                                    </li>

                                    <li>
                                        <a href="list_people.php">人物</a><a id = "peoplenum"> (0)</a>
                                        <a class="btn btn-primary pull-right" id="" href="edit_people.php">新增</a>
                                    </li>

                                    <li>
                                        <a href="list_activity.php">活動</a><a id = "activitynum"> (0)</a>
                                        <a class="btn btn-primary pull-right" id="" href="edit_activity.php">新增</a>
                                    </li>
    ...
    <script src="assets/js/api/workListNum.js"></script>
