...
<body data-spy="scroll" data-target=".navbar-collapse">
   ...
   echo '<input type="hidden" id ="uid" value="'.$_SESSION['UserId'].'">';
                            ...
                            <form name="sentMessage" id="" novalidate>
                                <div class="col-sm-10 col-sm-offset-1">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>所在地址:</label>
                                            <input id = "Place_address" type="text" class="form-control" id="" placeholder="請填寫詳細地址">
                                        </div>
                                    </div>

                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>空間簡介描述資料:</label>
                                            <textarea class="form-control" maxlength="500" id="SpaceDescription"
                                                placeholder="請輸入文章內容，300~500字/科普化"></textarea>
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>空間分類一:</label>
                                            <select id = "SpaceClassOne" name="" class="form-control-dropdown form-control">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>空間分類二:</label>
                                            <select id = "SpaceClassTwo" name="" class="form-control-dropdown form-control">
                                    ...
                                    <button type="submit" onclick="Spaceinsert()" class="btn btn-default">發表新文章</button>
                                </div>
    ...
    <script src="assets/js/api/spaceInsert.js"></script>
    <script>
