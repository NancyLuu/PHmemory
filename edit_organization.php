...
?>
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            <form name="sentMessage" id="" novalidate>
                                <div class="col-sm-10 col-sm-offset-1">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>組織介紹描述資料:</label>
                                            <textarea maxlength="500" class="form-control" id="OrganizationDescription" placeholder=""></textarea>
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>組織分類一:</label>
                                            <select id = "OrganizationClassOne" name="" class="form-control-dropdown form-control">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>組織分類二:</label>
                                            <select id = "OrganizationClassTwo" name="" class="form-control-dropdown form-control">
                                    ...
                                    <button type="submit" onclick="Organizationinsert()"  class="btn btn-default">發表新文章</button>
                                </div>
    ...
    <script type="text/javascript" src="assets/js/api/organizationinsert.js"></script>>
    <script>
