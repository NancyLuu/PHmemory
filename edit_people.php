...
?>
                            ...
                            <form name="sentMessage" id="" novalidate>
                                <div class="col-sm-10 col-sm-offset-1">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>姓名:</label>
                                            <input type="text" class="form-control" id="PeopleName" required=""
                                                data-validation-required-message="Please enter people name.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>性別:</label>
                                            <select id = "Sex" name="" class="form-control-dropdown form-control">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>國籍:</label>
                                            <input type="text" class="form-control" id="Country" placeholder="請填寫詳細地址">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            ...
                                            <input type="date" class="form-control" id="Birthday" required=""
                                                data-validation-required-message="請輸入生日時間">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>人物介紹描述資料:</label>
                                            <textarea maxlength="500" class="form-control" id="PeopleDescription" placeholder=""></textarea>
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>人物分類一:</label>
                                            <select id = "PeopleClassOne" name="" class="form-control-dropdown form-control">
                                    ...
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <label>人物分類二:</label>
                                            <select id = "PeopleClassTwo" name="" class="form-control-dropdown form-control">
                                    ...
                                    <button type="submit" onclick="Peopleinsert()" class="btn btn-default">發表新文章</button>
                                </div>
    ...
    <script src="assets/js/api/peopleInsert.js"></script>
    <script>
